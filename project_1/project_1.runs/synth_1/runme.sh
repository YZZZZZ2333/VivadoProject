...
HD_PWD='C:/Users/YangZhen/Documents/VivadoProject/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log a1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source a1.tcl
