...
HD_PWD='C:/Users/YangZhen/OneDrive - cstdlib/º¼µç/EDA/VivadoProject/vga_disp_2/vga_disp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_disp.tcl -notrace
