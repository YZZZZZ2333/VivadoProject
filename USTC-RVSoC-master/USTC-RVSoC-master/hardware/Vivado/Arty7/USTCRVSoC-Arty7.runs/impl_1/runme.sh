...
HD_PWD='C:/Users/YangZhen/Documents/VivadoProject/USTC-RVSoC-master/USTC-RVSoC-master/hardware/Vivado/Arty7/USTCRVSoC-Arty7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Arty7_USTCRVSoC_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Arty7_USTCRVSoC_top.tcl -notrace
