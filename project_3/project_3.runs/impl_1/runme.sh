...
HD_PWD='C:/Users/YangZhen/Documents/VivadoProject/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt10_dt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnt10_dt.tcl -notrace
