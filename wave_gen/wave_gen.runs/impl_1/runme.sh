...
HD_PWD='C:/Users/YangZhen/Documents/VivadoProject/wave_gen/wave_gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wave_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wave_gen.tcl -notrace
