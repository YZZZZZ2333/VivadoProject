...
HD_PWD='C:/Users/YangZhen/Documents/VivadoProject/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log a1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source a1.tcl -notrace
