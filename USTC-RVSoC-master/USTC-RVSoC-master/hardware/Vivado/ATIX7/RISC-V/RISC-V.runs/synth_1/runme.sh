...
HD_PWD='C:/Users/YangZhen/Documents/EDA/USTC-RVSoC-master/USTC-RVSoC-master/hardware/Vivado/ATIX7/RISC-V/RISC-V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Artix_SoC_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Artix_SoC_top.tcl
