...
HD_PWD='C:/Users/YangZhen/Documents/VivadoProject/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt10_dt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnt10_dt.tcl
