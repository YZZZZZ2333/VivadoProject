...
HD_PWD='C:/Users/YangZhen/Documents/VivadoProject/vga_disp_2/vga_disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_disp.tcl
