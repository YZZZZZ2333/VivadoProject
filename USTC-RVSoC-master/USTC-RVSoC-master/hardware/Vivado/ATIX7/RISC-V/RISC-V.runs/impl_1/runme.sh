...
HD_PWD='E:/OneDrive - cstdlib/º¼µç/EDA/VivadoProject/USTC-RVSoC-master/USTC-RVSoC-master/hardware/Vivado/ATIX7/RISC-V/RISC-V.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Artix_SoC_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Artix_SoC_top.tcl -notrace
