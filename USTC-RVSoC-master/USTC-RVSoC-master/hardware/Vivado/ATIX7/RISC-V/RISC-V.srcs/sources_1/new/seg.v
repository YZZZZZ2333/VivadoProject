...
always@(posedge clock_25m)begin
    case(cnt[18:16]) 
    3'b000:
        begin SEL <= 8'b1111_1110;end
    3'b001:                               
        begin SEL <= 8'b1111_1101;end
    3'b010:                              
        begin SEL <= 8'b1111_1011;end
    3'b011:                               
        begin SEL <= 8'b1111_0111;end
    3'b100:                            
        begin SEL <= 8'b1110_1111;end
    3'b101:                              
        begin SEL <= 8'b1101_1111;end
    3'b110:                             
        begin SEL <= 8'b1011_1111;end
    3'b111:                             
        begin SEL <= 8'b0111_1111;end    
    endcase
end
